...
/* __string_template__9ced253949b5d5c702dd40036002e1c720aeba9fe216cf3dbd4b01567bdec39e */
class __TwigTemplate_bfbe5e563d9abde4a15d2b9ac7a6628636c9612a81dd196e505a7edc6356ec4a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class='image-profile-user' > ";
        ...
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["name_1"] ?? null), 2, $this->source), "html", null, true);
...
<div class='separateur-comment'> </div>
    ...
    {
        return "__string_template__9ced253949b5d5c702dd40036002e1c720aeba9fe216cf3dbd4b01567bdec39e";
    }
    ...
    {
        return new Source("", "__string_template__9ced253949b5d5c702dd40036002e1c720aeba9fe216cf3dbd4b01567bdec39e", "");
    }
