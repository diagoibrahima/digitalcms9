 ...
 */
class SelfHostedController extends ControllerBase {

  private $plugins_folder;

  private $self_hosted_URL = selfHostedPath;
  ...
  public function __construct(ConfigFactoryInterface $config_factory,
    ...
    $this->plugins_folder = DRUPAL_ROOT . $this->self_hosted_URL;
    $this->plugin_file = $this->plugins_folder . '/N1EDEco/plugin.js';
