...
jQuery(document).ready(function () {
  ...
  jQuery("article .node-content p").append('<div class="contextual simpler_quickedit-do"><button class="trigger focusable" type="button"><i class="fa fa-trash-o" aria-hidden="true"></i></button></div>')
